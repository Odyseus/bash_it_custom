...
export FZF_DEFAULT_OPTS='
  --color=bg+:#073642,bg:#002b36,spinner:#719e07,hl:#5bf582
  --color=fg:#ffffff,header:#fdd500,info:#00e0ff,pointer:#ffffff
  --color=marker:#ffffff,fg+:#fdd500,prompt:#ffffff,hl+:#5bf582
'
